...
public class Drive {
    ...
    public void InitEncoderController(Object Spark) {
        Devices.InitEncoderController(Spark,KP,KD,KI,MINOUT,MAXOUT,IZONE,FFVALUE,TARGETRPM, 0, ControlType.kPosition); 
    }
